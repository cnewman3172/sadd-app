...
export default function TopNav(){
  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur bg-white/60 dark:bg-black/30 border-b border-black/10 dark:border-white/10">
        ...
        <div className="flex items-center gap-3">
          {user && (
            <div className="relative">
              ...
              {menuOpen && (
                <div className="absolute right-0 mt-2 w-56 rounded border bg-white text-black dark:bg-neutral-900 dark:text-white shadow">
                  {links.map(l=> (
