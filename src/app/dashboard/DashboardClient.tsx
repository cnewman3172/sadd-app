        ...
        <Card title="Live Ops">
          ...
          <div className="mt-3 grid grid-cols-1 gap-2 text-sm sm:grid-cols-3">
            {[{
              ...
              <div key={stat.label} className="flex flex-col items-center justify-center rounded-2xl border border-white/20 bg-white/70 px-4 py-3 text-center shadow-sm backdrop-blur-sm dark:border-white/10 dark:bg-white/10">
